      ...
      <>
        ...
        <section className="projects">
          <div className='quarantrail'>
            <h2>QuaranTrail</h2>
            <h3>Summary</h3>
            <p>This is a game where the user practices social distancing and self quarantine practices. It is geared towards teens and older. We built this game for user to have fun and alleviate boredom</p>
            <h3>Tech Stack</h3>
